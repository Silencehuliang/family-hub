...
export function TodoDetailPageDesktop() {
  ...
  return (
    <div style={{ padding: 16, maxWidth: 480, margin: '0 auto' }}>
      ...
      <Card>
        ...
        {item.completedAt && <><br /><Text type="secondary" style={{ fontSize: 12 }}>完成于 {dayjs.unix(item.completedAt).format('YYYY-MM-DD HH:mm')}</Text></>}
      </Card>
